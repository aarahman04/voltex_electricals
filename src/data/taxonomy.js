...
//
// The spine (SUBCATEGORY_ORDER) comes from Product_Catalog.md —
...
export const brandListingPath = (category, brandSlug) =>
  `${categoryPath(category)}/${encodeURIComponent(brandSlug)}`;
...
// Data-backed subcategories (from products.getSubcategories), in canonical
// display order. A subcategory present in the data but missing from
// SUBCATEGORY_ORDER is appended after these, in the order first seen.
